...
from simple_commands import show_commands_handler, help_handler, unknown_command_handler, unknown_message_handler, error
...
if __name__ == '__main__':
    ...
    app.add_handler(show_commands_handler)
